...
public final class RedisUtil {
    ...
    public boolean set(Integer key, Object value, long time) {
        return this.set(String.valueOf(key),value,time);
    }
    /**
     * 递增
     * @param key 键
    ...
    public boolean lSet(Integer key, List<Object> value, long time) {
        return this.lSet(String.valueOf(key),value,time);
    }
    /**
     * 根据索引修改list中的某条数据
     * @param key 键
